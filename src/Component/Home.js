...
export default function Home() {
  ...
  return (
    <div>
      <NavBar />
      <section className="carousel slide" id="carouselExampleSlidesOnly" data-bs-ride="carousel">
      ...
      <div className="sec-banner bg-info">
        <div className="container ">
          <div className="row">
            {/* Block 1: Women */}
            <div className="col-md-6 col-xl-4 mb-4 ">
              <div className="position-relative block1">
                <img src="images/banner-01.jpg" alt="Women Collection" className="img-fluid border-4 border-primary border" />
            ...
            <div className="col-md-6 col-xl-4 mb-4">
              <div className="position-relative block1">
                <img src="images/banner-02.jpg" alt="Men Collection" className="img-fluid border-4 border-primary border" />
                <div className="block1-txt">
            ...
            <div className="col-md-6 col-xl-4 mb-4">
              <div className="position-relative block1">
                <img src="images/banner-06.jpg" alt="Accessories" className="img-fluid border-4 border-primary border" />
                <div className="block1-txt">
