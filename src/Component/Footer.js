            ...
            <div className='container-fluid bg-dark'>
                <div className='row offset-1 p-5  text-white'>
                    ...
                    <div className='col-lg-3'>
                        ...
                        <div className='fs-4 text-start text-white-50'>
                            <i className="p-3 mx-2 fa-brands fa-facebook"></i>
                            <i className="p-3 mx-2 fa-brands fa-pinterest"></i>
                            <i className="p-3 mx-2 fa-brands fa-square-instagram"></i>
                        </div>
                    </div>
